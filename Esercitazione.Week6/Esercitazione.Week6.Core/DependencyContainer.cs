...
public static class DependencyContainer
{
    ...
    private static readonly Lazy<Ninject.IKernel> _Kernel = new Lazy<Ninject.IKernel>(() => new StandardKernel());

    public static Ninject.IKernel Kernel { get { return new StandardKernel(); } }
